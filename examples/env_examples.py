...
print(f"base default value text: '{text_undefined_key}' replace: '{str(base_env.replace_vars(text_undefined_key, 'default'))}'")
...
print(f"concrete env get default key '{undefined_key}' = {str(concrete_env.get(undefined_key, 'default'))}")
print(f"concrete text: '{text}' replace: '{str(concrete_env.replace_vars(text))}'")
print(f"concrete default value text: '{text_undefined_key}' replace: '{str(concrete_env.replace_vars(text_undefined_key, 'default'))}'")
...
print(f"undefined env get default key '{var_name_1}' = {str(undefined_env.get(var_name_1, 'default'))}")
print(f"undefined text: '{text}' replace: '{str(undefined_env.replace_vars(text))}'")
print(f"undefined default value text: '{text_undefined_key}' replace: '{str(undefined_env.replace_vars(text_undefined_key, 'default'))}'")

print(f">>>>> Retest base env")
print(f"base env get undefined key '{var_name_1}' = {str(base_env.get(var_name_1))}")
print(f"base text: '{text}' replace: '{str(base_env.replace_vars(text))}'")