...
data = {'config1': {'key_1_1': 'config 1', 'key_1_2': 'test env var = ${test_var_1}'}, 'config2': {'key_2_1': 'config 2', 'key_2_2': 'test env var = ${test_var_2}', 'key_2_3': {'key_2_3_1': {'key_2_3_1_1': {'key_2_3_1_1_1': 'result'}}}}}
